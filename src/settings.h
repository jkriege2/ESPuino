// clang-format off
	...
	*/
	...
	#define BUTTON_MULTI_01   CMD_DIMM_LEDS_NIGHTMODE   //CMD_TOGGLE_WIFI_STATUS (disabled now to prevent children from unwanted WiFi-disable)
	#define BUTTON_MULTI_02   CMD_TOGGLE_WIFI_STATUS
